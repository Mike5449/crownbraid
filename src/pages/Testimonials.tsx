...
const testimonials = [
  { name: "Tameka J.", biz: "Beauty Supply Owner", quote: "CrownBraid is our #1 supplier. Consistent quality and the reorder process is seamless. Our shelves are always stocked." },
  ...
  { name: "Crystal B.", biz: "Salon Owner", quote: "We switched to CrownBraid six months ago and haven't looked back. Reliable, affordable, and trend-forward." },
  ...
  { name: "James H.", biz: "Multi-Store Owner", quote: "We stock CrownBraid in all 3 of our locations. The bulk case deals save us thousands every quarter." },
